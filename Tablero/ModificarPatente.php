...
$u = new Producciones();
$datos = $u->getDatosPatenteIdModificar($id);
                                ...
                                <div class="col-xs-11">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Modificando patente</h3>
                                        </div>
                                        <div class="panel-body">
                                            <form name="form" action="" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        <label for="telefono">Nombre de la patente *</label>
                                                        <input type="text" value="<?php echo $datos->getTitulo() ?>" id="tituloTxt" name="tituloTxt" placeholder="" class="form-control" required="true" required="true"/>
                                                        <input type="hidden" value="<?php echo $id?>"  name="idTraido" id="idTraido"/>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <label for="correo">Número de Autores *</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        <label for="nombre">Número de registro de la patente *</label>
                                                        <input type="text" value="<?php echo $datos->getIssn() ?>" name="issnTxt" id="issnTxt" placeholder="" autofocus="true" class="form-control" required="true"/>
                                                    </div>
                                                    <div class="col-xs-6">
