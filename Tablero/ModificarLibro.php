...
$u = new Producciones();
$datos = $u->getDatosLibrosIdModificar($id);
                                ...
                                <div class="col-xs-11">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Modificando libro</h3>
                                        </div>
                                            ...
                                            <form name="form" action="" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <select class="form-control" id="tipoRevistaCmb" name="tipoRevistaCmb" required="true">
                                                            ...
                                                            <option value="1">LIBRO CON ISBN</option>
                                                            <option value="2">CAPITULO(S) DE UN LIBRO CON ISBN</option>
                                                            <option value="3">MÓDULO CON ISBN</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <label for="telefono">Título del Libro</label>
                                                        <input value="<?php echo $datos->getTitulo() ?>" type="text" id="tituloTxt" name="tituloTxt" placeholder="" class="form-control" required="true" required="true"/>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-4">
                                                        ...
                                                        <input type="number" value="<?php echo $datos->getAutores() ?>"  name="numeroAutoresNbr" id="numeroAutoresNbr" required="true" class="form-control" required="true"/>
                                                    </div>
                                                    <div class="col-xs-4">
                                                        <label for="nombre">ISBN del libro *</label>
                                                        <input type="text" name="issnTxt" value="<?php echo $datos->getIssn() ?>" id="issnTxt" placeholder="M:monografía; P:practicas" class="form-control" required="true"/>
                                                    </div>
                                                    <div class="col-xs-4">
                                                        <label for="nombre">Fecha de Publicación *</label>
                                                        <input type="date" value="<?php echo $datos->getFechaPublicacion() ?>" max="<?php $hoy = date("Y-m-d");
