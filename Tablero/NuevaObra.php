                                ...
                                <div class="col-xs-11">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Agregando una nueva obra artística</h3>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <select class="form-control" id="tipoRevistaCmb" name="tipoRevistaCmb" required="true">
                                                            ...
                                                            <option value="1">CREACIÓN ORIGINAL INTERNACIONAL</option>
                                                            <option value="2">CREACIÓN ORIGINAL NACIONAL</option>
                                                            <option value="3">CREACIÓN COMPLEMENTARIA INTERNACIONAL</option>
                                                            <option value="4">CREACIÓN COMPLEMENTARIA NACIONAL</option>
                                                            <option value="5">INTERPRETACIÓN INTERNACIONAL</option>
                                                            <option value="6">INTERPRETACIÓN NACIONAL</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-xs-6">
