                                ...
                                <div class="col-xs-11">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Agregando un nuevo libro</h3>
                                        </div>
                                            ...
                                            <form name="form" action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-4">
                                                        ...
                                                        <input type="text" name="issnTxt" id="issnTxt" placeholder="M:monografía; P:practicas" class="form-control" required="true"/>
                                                    </div>
                                                    <div class="col-xs-4">
