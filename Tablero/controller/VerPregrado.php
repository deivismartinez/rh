...
require_once("../clases/Estudios.php");
    ...
    $curso = $estudios->getDatosPregradoId($id);
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="row">
                    ...
                    Datos Registrados
                        ...
                        <div class="panel-body">
                            ...
                            <input disabled="true" type="text" value="<?php echo $curso->getDuracion()?>" class="form-control">
                            </div>
                            <div class="col-xs-6">
                            ...
                            <div class="col-md-12">
                                <a href="VerAdjuntoP.php?id=<?php echo $id ?>"  target="_blank">
