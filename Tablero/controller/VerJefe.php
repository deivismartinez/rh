        ...
        <div class="wrapper">
            <div class="sidebar" data-color="green" data-image="../assets/img/sidebar-5.jpg">
                <div class="sidebar-wrapper">
                    ...
                    <ul class="nav">
                        <li >
                            <a href="../../Admin/inicioAdminJefe.php">
                                <i class="pe-7s-photo-gallery"></i>
                                <p>Inscritos por Áreas</p>
                            </a>
                        </li>
                        <li >
                            <a href="../../Admin/CalificadosJefe.php">
                                <i class="pe-7s-photo-gallery"></i>
                        ...
                        <li>
                            <a href="../../Admin/DocentesSinArea.php">
                                <i class="pe-7s-photo-gallery"></i>
                                <p>Docentes Sin Area Escogida</p>
                            </a>
                        </li>
                        <li>
                            <a href="../../Admin/ModificarClaveJefe.php">
                                <i class="pe-7s-photo-gallery"></i>
...
<!--                        <li>
    ...
    echo '<td><select disabled="true" class="form-control" id="puntoscategoria" name="puntoscategoria" required="true">'
    ...
    echo '</select></td>';
    echo '<td><textarea disabled="true" class="form-control" id="comentarioCategoria" name="comentarioCategoria">'.$puntosDigitados->getcomentariocategoria().'</textarea></td>';
    ?>
...
foreach ($especializacion as $arregloEspecializacion) {
    ...
    ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-4">
                                            ...
                                            <select disabled="true" class="form-control" id="puntosestudios" name="puntosestudios" required="true">
                                                <option value="" selected="true">SELECCIONE</option>
                                        ...
                                        <div class="col-xs-5">
                                            ...
                                            <textarea disabled="true" id="comentarioEstudios" name="comentarioEstudios" class="form-control"><?php echo $puntosDigitados->getcomentarioestudio() ?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                </div>
    ...
    ?>
                                        ...
                                        <div class="col-xs-4">
                                            ...
                                            <input disabled="true" value="<?php echo $puntosDigitados->getexperiencia() ?>" type="text" size="4" id="puntosexperiencia" name="puntosexperiencia" class="form-control" required="true"/>
                                        </div>
                                        <div class="col-xs-5">
                                            <label for="">Comentario</label>
                                            <textarea disabled="true" id="comentarioExperiencia" name="comentarioExperiencia" class="form-control"><?php echo $puntosDigitados->getcomentarioexperiencia() ?></textarea>
                                        </div>
                                    </div>
                                    </div>
                                </div>
    ...
    ?>
                                        ...
                                        <div class="col-xs-4">
                                            ...
                                            <input disabled="true" value="<?php echo $puntosDigitados->getinvestigacion() ?>" type="text" size="4" id="puntosinvestigaciones" name="puntosinvestigaciones" class="form-control" required="true"/>
                                        </div>
                                        <div class="col-xs-5">
                                            <label for="">Comentario</label>
                                            <textarea disabled="true" id="comentarioInvestigaciones" name="comentarioInvestigaciones" class="form-control"><?php echo $puntosDigitados->getcomentarioinvestigacion() ?></textarea>
                                        </div>
                                    </div>
                                    </div>
                                </div>
    ...
    ?>
                                                        ...
                                                        foreach ($patentes as $arregloPat) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php
                                                                $puntosPublicaciones = $puntosPublicaciones + 60;
            echo '<td>60</td>';
    ...
    ?>
                                        ...
                                        <div class="col-xs-4">
                                            ...
                                            <input disabled="true" value="<?php echo $puntosDigitados->getpublicaciones() ?>" type="text" size="4" id="puntosproduccion" name="puntosproduccion" class="form-control" required="true"/>
                                        </div>
                                        <div class="col-xs-5">
                                            <label for="">Comentario</label>
                                            <textarea disabled="true" id="comentarioProduccion" name="comentarioProduccion" class="form-control"><?php echo $puntosDigitados->getcomentariopublicaciones() ?></textarea>
                                        </div>
                                    </div>
                                    </div>
                                </div>
