                    ...
                    <div class="col-xs-7">
                        <div class="panel panel-danger">
                            <div class = "panel-heading">
                                <h2 class = "panel-title"><h2><p align=center><b>No se envió el correo</b></p></h2></h2>
                            </div>
                            <div class="panel-body">
                                <form method="POST" action="" name="entradaFrm" id="entradaFrm">
                                    <div class="form-group">
                                        <p align="center">
                                            <b>Su identidad no corresponde con su correo, el correo no está registrado, o no existe</b>
                                        </p>
                                        <div class="col-md-12">
                                    <a href="../Entrada.html">
