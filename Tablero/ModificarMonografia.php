...
$u = new Producciones();
$datos = $u->getDatosMonografiaIdModificar($id);
if (isset($_POST["tituloTxt"])) {
    $u = new Producciones();
    $u->actualizarMonografia();
}
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="col-xs-11">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Modificando monografía o practicas</h3>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <select class="form-control" id="tipoRevistaCmb" name="tipoRevistaCmb" required="true">
                                                            ...
                                                            <option value="4">ASESOR DE MONOGRAFIA O PROYECTO DE GRADO</option>
                                                            <option value="5">ASESOR DE PRACTICAS CON OPCION DE GRADO</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-xs-6">
