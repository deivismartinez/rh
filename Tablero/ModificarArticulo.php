...
$u = new Producciones();
$datos = $u->getDatosArticuloIdModificar($id);
if (isset($_POST["tituloTxt"])) {
    $u = new Producciones();
    $u->actualizarArticulo();
}
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="col-xs-11">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Modificando articulo</h3>
                                        </div>
                                            ...
                                            <form name="form" action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <input value="<?php echo $datos->getRevista() ?>" type="text" name="revistaTxt" id="revistaTxt" placeholder="" autofocus="true" class="form-control" required="true"/>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <label for="correo">Numero de Autores *</label>
                                                        <input value="<?php echo $datos->getAutores() ?>" type="number" name="numeroAutoresNbr" id="numeroAutoresNbr" required="true" class="form-control" required="true"/>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <input value="<?php echo $datos->getIssn() ?>" type="text" name="issnTxt" id="issnTxt" placeholder="" autofocus="true" class="form-control" required="true"/>
                                                    </div>
                                                    <div class="col-xs-6">
