...
if (isset($usuario)) {
    ...
    $programaPost = $programas->getProgramaUsuarioPerfilPost($usuario);
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="col-xs-12">
                                    ...
                                    ?>
                                    <div class="col-xs-12">
                                        <a href="NuevoProgramaPostgrados.php"><i class="pe-7s-plus"></i> <ins><b>Agregando una nueva área de conocimiento-Programas Postgrados</b></ins></a>
                                    </div>
                                ...
                                <div class="col-xs-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($programaPost as $arreglo) {
                                                ?>
                                            <tr>
                                                ...
                                                <?php
                                                    $url = "eliminar('controller/EliminarProgramaPostgrado.php?id=" . $arreglo[3] . "&idUsuario=" . $usuario->getId() . "');";
                                                    ?>
                                                <td>
                                                    <?php ///abre condicion periodo
                                                        //  if ($p->PeridoSede("'" . $docente->getSede() . "'")) {
