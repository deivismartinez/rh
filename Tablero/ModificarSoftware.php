...
$u = new Producciones();
$datos = $u->getDatosSoftwareIdModificar($id);
                                ...
                                <div class="col-xs-11">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Modificando software</h3>
                                        </div>
                                        <div class="panel-body">
                                            <form name="form" action="" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <label for="telefono">Nombre del software *</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <label for="nombre">Fecha de publicación primera versión *</label>
