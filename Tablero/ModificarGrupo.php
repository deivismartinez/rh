...
$u = new Producciones();
$datos = $u->getDatosGrupoIdModificar($id);
                                ...
                                <div class="col-xs-11">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Modificando grupo de investigación</h3>
                                        </div>
                                        <div class="panel-body">
                                            <form name="form" action="" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        <label for="telefono">Clasificación del grupo Según COLCIENCIAS *</label>
                                                        <select class="form-control" id="tipoRevistaCmb" name="tipoRevistaCmb" required="true">
                                                            ...
                                                            <option value="A2">CLASIFICACIÓN A</option>
                                                            <option value="B">CLASIFICACIÓN B</option>
                                                            <option value="C">CLASIFICACIÓN C</option>
                                                            <option value="RC">RECONOCIDO POR COLCIENCIAS</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <label for="telefono">Nombre del grupo </label>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        <label for="nombre">Categoria de investigador *</label>
                                                        <select class="form-control" id="categoriaInvestigadorCmb" name="categoriaInvestigadorCmb" required="true">
                                                            <option value="">SELECCIONE</option>
                                                    ...
                                                    <div class="col-xs-6">
                                                        <label for="nombre">Fecha de Vinculación *</label>
