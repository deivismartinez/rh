            ...
            <div class="sidebar" data-color="green" data-image="assets/img/sidebar-5.jpg">
                ...
                <div class="sidebar-wrapper">
                    ...
                    <ul class="nav">
                        ...
                        <?php
                        ///abre condicion sede A DISTANCIA
                        if ($usuario->getSede() != 'A DISTANCIA') {
                            ...
                            <?php
                            ///CIERRA condicion sede A DISTANCIA
                        }
                        ?>
                        <li class="active">
                            ...
                            <div class="col-xs-11">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Agregando una nueva área de conocimiento-Programas Postgrados</h3>
                                    </div>
