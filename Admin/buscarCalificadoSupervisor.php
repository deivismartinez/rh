...
//if (!empty($buscar)) {
buscarSupervisor($buscar, $programa, $usuario, $area, $prog);
//}

function buscarSupervisor($criterio, $programa, $docente, $area, $prog)
{
    cabeza();
    require_once("../Tablero/clases/Docente.php");
    $docentes = new Docente();
    $criterio = strtoupper($criterio);
    $lista = $docentes->getDocentesCalificacionSupervisor($criterio, $prog, $area, $docente->getSede());
    ...
    foreach ($lista as $arreglo) {
        ...
        <tr>
            ...
            <!--<td><?php // echo $totalPuntos 
                    ?></td>-->
            <?php
            $urlVer = "../Tablero/controller/VerSupervisor.php?id=" . $arreglo[6] . "&nombre=" . $arreglo[1] . "&tipo=1";
            ?>
            <td>
    ...
    echo '<table cellspacing="0" cellpadding="0" id="mi-tabla" class="table-bordered tabla">
                                                <thead>
                                                    ...
                                                    <th><span>No.</span></th>
                                                        ...
                                                        <th><span>Grado de Estudio</span></th>
                                                        <th><span>Titulo Obtenido</span></th>
                                                        <th><span></span></th>
                                                    </tr>
                                                </thead>
                                                <tbody>';
