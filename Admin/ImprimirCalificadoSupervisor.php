...
function cabeza($programa) {
    echo '<page style="font-size: 8px">';
    echo '<h3 align="center">ASPIRANTES CALIFICADOS EN EL BANCO DE HOJA DE VIDA</h3>';
    echo "
...
";
    echo ' <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">';
   echo '<table align="center" cellspacing="0" border="1" cellpadding="0" id="mi-tabla" class="table-bordered tabla">';
    echo "
                                                ...
                                                <thead>
                                                    ...
                                                    <th><span>Tipo</span></th>
                                                        ...
                                                        <th><span>Max. Nivel Estudio</span></th>
                                                        
                                                        <th><span>Titulo Obtenido</span></th>
                                                        <th><span>institucion</span></th>
                                                    </tr>
                                                </thead>
                                                <tbody>";
}
