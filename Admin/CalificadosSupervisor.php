    ...
    <div class="wrapper">
        <div class="sidebar" data-color="green" data-image="../images/sidebar-5.jpg">
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    <!-- <li>
                            <a href="inicioAdminSupervisor.php">
                                <i class="pe-7s-photo-gallery"></i>
                                <p>Inscritos por Áreas</p>
                            </a>
                        </li> -->
                    <li class="active">
                        <a href="CalificadosSupervisor.php">
                            <i class="pe-7s-photo-gallery"></i>
                            <p>Inscritos Calificados</p>
                        </a>
                    </li>
                    <li>
                        <a href="ModificarClaveSupervisor.php">
                            <i class="pe-7s-photo-gallery"></i>
...
<script>
    function buscar() {
        ...
        $.ajax({
            type: "POST",
            url: "buscarCalificadoSupervisor.php",
            data: {
                'b': $("#busqueda").val(),
                'area': area,
                'prog': prog
    ...
    function imprimir() {
        consulta = $("#busqueda").val();
        area = $("#areasCmb").val();
        url = "ExportarCalificadoSupervisor.php?programa=" + prog + "&b=" + consulta;
        window.open(url)
    }
    $(function() {
