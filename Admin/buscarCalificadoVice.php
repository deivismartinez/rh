...
function buscar($criterio,$programa, $docente,$area,$prog) {
    ...
    $lista = $docentes->getDocentesCalificacionVice($criterio,$prog,$area,$docente->getSede());
...
//        $totalPuntos = 100;
        ...
        <tr>
            ...
            <?php
            $urlVer = "../Tablero/controller/VerVice.php?id=".$arreglo[6]."&nombre=".$arreglo[1]."&tipo=1";
            ?>
            <td>
