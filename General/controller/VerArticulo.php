                                ...
                                <div class="col-xs-11">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Ver datos del articulo</h3>
                                        </div>
                                            ...
                                            <form name="form" action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <input disabled="true" value="<?php echo $datos->getIssn() ?>" type="text" name="issnTxt" id="issnTxt" placeholder="" autofocus="true" class="form-control" required="true"/>
                                                    </div>
                                                    <div class="col-xs-6">
