                                ...
                                <div class="col-xs-11">
                                    <div class="panel panel-primary">
                                        <div class="panel-heading">
                                            <h3 class="panel-title">Ver datos del premio</h3>
                                        </div>
                                        <div class="panel-body">
                                            <form name="form" action="" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <label for="telefono">Nombre del Premio</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <label for="nombre">Institución o evento donde se hace la entrega del premio</label>
                                                        <input disabled="true" value="<?php echo $datos->getRevista() ?>" type="text" name="revistaTxt" id="revistaTxt" placeholder="" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        <label for="correo">Número de premiados</label>
                                                        <input disabled="true" value="<?php echo $datos->getAutores() ?>" type="text" name="numeroAutoresNbr" id="numeroAutoresNbr" class="form-control" />
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <label for="nombre">Fecha de entrega del premio *</label>
                                                        <input disabled="true" value="<?php echo $datos->getFechaPublicacion() ?>" type="date" max="<?php $hoy = date("Y-m-d");
echo $hoy;
